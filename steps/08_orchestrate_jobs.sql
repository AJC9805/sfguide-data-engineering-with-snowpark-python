...
WAREHOUSE = HOL_WH
WHEN
  SYSTEM$STREAM_HAS_DATA('POS_FLATTENED_V_STREAM') -- Jika stream pada POS_FLATTENED_V_STREAM memiliki data baru, maka task akan dijalankan
AS
...
WHEN
  SYSTEM$STREAM_HAS_DATA('ORDERS_STREAM') -- Jika stream pada ORDERS_STREAM memiliki data baru, maka task akan dijalankan
AS
...
SHOW TASKS LIKE 'DAILY_CITY_METRICS_UPDATE_TASK';
-- ----------------------------------------------------------------------------
